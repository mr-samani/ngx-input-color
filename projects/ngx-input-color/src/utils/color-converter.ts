import { numberInputToObject, rgbaToHex, rgbToCmyk, rgbToHex, rgbToHsl, rgbToHsv } from './conversion';
import { names } from './css-color-names';
import { inputToRGB } from './format-input';
import { CMYK, HSL, HSLA, HSV, HSVA, Numberify, RGB, RGBA } from './interfaces';
...
export class TinyColor {
  ...
  static cmykToRgb(cmyk: CMYK, alpha: number): RGBA {
    const c = +cmyk.c / 100;
    const m = +cmyk.m / 100;
    const y = +cmyk.y / 100;
    const k = +cmyk.k / 100;
