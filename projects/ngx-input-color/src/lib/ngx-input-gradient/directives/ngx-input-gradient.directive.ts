...
import { NgxInputGradientComponent } from '../components/ngx-input-gradient.component';
...
export class NgxInputGradientDirective implements AfterViewInit, OnDestroy, ControlValueAccessor, Validator {
  ...
  setPosition() {
    ...
    this.renderer.setStyle(this.pickerEl, 'z-index', '1001');

    this._doc.body.appendChild(this.pickerEl); // لازم برای محاسبه دقیق اندازه
